...
def run_tokenize_prompt_and_output(
    ...
    return tokenize_prompt_and_output(prompt_strs,
                                      output_strs,
                                      tokenizer)
...
def run_compute_rollout_rewards(
    ...
    """
    # raise NotImplementedError
    from cs336_alignment.algs.grpo import compute_rollout_rewards
...
def run_aggregate_loss_across_microbatch(
    ...
    """
    # raise NotImplementedError
    from cs336_alignment.algs.grpo import aggregate_loss_across_microbatch
...
def run_grpo_train_step(
    ...
    """
    from cs336_alignment.algs.grpo import grpo_train_step
