...
def run_get_batch(
    ...
    """
    from src.nn.utils import load_batch

    return load_batch(dataset, batch_size, context_length, torch.device(device))
...
def run_save_checkpoint(
    ...
    """
    from src.nn.utils import save_checkpoint
...
def run_load_checkpoint(
    ...
    """
    from src.nn.utils import load_checkpoint
